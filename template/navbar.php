...
<nav class="navbar navbar-expand-lg navbar-dark blue">
  <div class='container'>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <!-- Search form -->
      <?php if (isset($_SESSION['user']) && $valid) : ?>
        <a href="#" data-toggle='modal' data-target="#modalCart" style="color: white; margin-right: 15px">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="pay.php" class="btn btn-primary">On paye !</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="options text-center text-md-right mt-1">
            <p>Nous rejoindre ?<a href="register.php">S'inscrire</a></p>
          </div>
